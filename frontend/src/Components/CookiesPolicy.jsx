...
const myHTML = `<h1>Cookie Policy for FJob</h1>

<p>This is the Cookie Policy for FJob, accessible from fjob.com</p>
...
<ul>
<li>Email: kacperwlodarczyk@protonmail.com</li>
...
export const CookiesPolicyPage = () => <div dangerouslySetInnerHTML={{__html: mySafeHTML}}/>;